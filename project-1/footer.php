<div class="big-footer">
    <div class="container-fluid">
      ...
      <div class="col-lg-2">
        <div class="logo-menu">
          <ul>
            <li><a href="http://facebook.com"><i class="fa fa-facebook-square text-green"></i></a></li>
            <li><a href="http://twitter.com"><i class="fa fa-twitter text-green"></i></a></li>
            <li><a href="http://google.com"><i class="fa fa-google-plus-square text-green"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
