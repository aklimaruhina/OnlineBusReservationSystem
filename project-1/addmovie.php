...
if ($_POST): 
	...
	$query = "INSERT INTO `movie reserve` (`id`, `mvname`, `mvdescription`, `rldate`, `director`, `showdate`, `hallname`, `moviepic`) VALUES (NULL, '$mvname', '$mvdescription', '$rldate', '$director', 'showdate', 'hallname', '$filepath')";
