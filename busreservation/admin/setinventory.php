							...
							while($obj = $result->fetch_object())
								{
									...
									echo '<td style="border-left: 1px solid #C1DAD7;">'.$obj->date.'</td>';
									$rrad=$obj->bus;
									$query1 = "SELECT * FROM route WHERE id='$rrad'";
									$result1= $mysqli->query($query1);

									while($objj = $result1->fetch_object())
									{
										echo '<td><div align="right">'.$objj->type.'</div></td>';
										echo '<td><div align="right">'.$objj->route.'</div></td>';
									}
									echo '<td><div align="right">'.$obj->seat.'</div></td>';
									echo '<td><div align="right">'.$obj->transactionnum.'</div></td>';
									echo '<td><div align="center"><a href="#" id="'.$obj->id.'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
